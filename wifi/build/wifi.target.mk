...
$(obj).target/wifi.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/wifi.node: LIBS := $(LIBS)
$(obj).target/wifi.node: TOOLSET := $(TOOLSET)
$(obj).target/wifi.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/wifi.node
# Add target alias
.PHONY: wifi
wifi: $(builddir)/wifi.node

# Copy this to the executable output path.
$(builddir)/wifi.node: TOOLSET := $(TOOLSET)
$(builddir)/wifi.node: $(obj).target/wifi.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/wifi.node
# Short alias for building this executable.
.PHONY: wifi.node
wifi.node: $(obj).target/wifi.node $(builddir)/wifi.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/wifi.node
